...
function Landing() {
  ...
  return (
    <form className="input-form" >
      ...
      <Card><Card.Img style={{ maxWidth: '300px', height: 'auto' }} variant="top" src="/Images/b1713295-2de8-450b-bfbf-12d53ec11d23.webp"/></Card>
      ...
      <Card><Card.Img style={{ maxWidth: '300px', height: 'auto' }} variant="top" src="/Images/f40f7f8c-acc0-48d7-84d2-85db448634bd.webp"/></Card>
